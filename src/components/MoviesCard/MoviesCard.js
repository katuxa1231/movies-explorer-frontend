...
function MoviesCard({ isLiked, isFavorite = false }) {
  return (
    <article className="movies-card">
      ...
      <div className="movies-card__wrapper">
        ...
        {isFavorite ? (<button className="movies-card__delete-button">
        ...
        </button>) : (<button className={`movies-card__like-button ${isLiked && 'movies-card__like-button_active'}`}>
